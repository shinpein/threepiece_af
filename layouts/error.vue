<template>
    <div class="background error-page-wrapper background-color background-image">
        <div class="content-container shadow">
            ...
            <div class="context secondary-text-color">
                <p>
                    一時的にアクセス出来ない状態か、移動もしくは削除されてしまった可能性があります。
                </p>
            </div>
        </div>
    </div>
...
border-color: rgba(12, 12, 13, 1) !important;
}
.button {
